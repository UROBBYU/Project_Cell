...
, samples[15][4] = { // Number half-byte codes:
    ...
    {0, 1, 1, 1},//12
    {1, 1, 1, 1},//13
    {0, 1, 0, 1},//Extra Imperial March
    {0, 1, 1, 0} //Extra Happy Birthday
};
...
void loop()
{
    ...
    if(timeflag > millis()) {
     ...
     if(samples[i][0] == check[0] &&
        ...
        int beat[] = {10, 1, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 1, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 1, 10, 10, 10, 10, 10, 10, 10, 1, 10, 10, 10, 10, 10, 10, 10, 1, 10, 10, 10, 10, 10, 10, 10, 10, 10};
