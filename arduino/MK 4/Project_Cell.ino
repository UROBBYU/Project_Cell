...
unsigned int i1, i2, i3, i4, ans, samples[14][4] = { // Number half-byte codes:
    {1, 0, 0, 0},//1
    {0, 1, 0, 0},//2
    {0, 0, 1, 0},//3
    {0, 0, 0, 1},//4
...
void loop()
{
    ...
    if(timeflag > millis()) {
     ...
     if(samples[i][0] == check[0] &&
        ...
        int beat[] = {2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 1, 1};
                playSound("d d d c dd c dd", beat, 150, 15);
        } else {
        Serial.print("wrong");
        digitalWrite(Red, HIGH);
        int beat[] = { 1, 1};
